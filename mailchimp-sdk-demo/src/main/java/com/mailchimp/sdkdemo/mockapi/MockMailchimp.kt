...
class MockMailchimp(mockInjector: MailchimpInjector) :
    Mailchimp(mockInjector) {
    ...
    companion object {
         ...
         */
        fun setAudienceAsMock(mockMailchimp: MockMailchimp) {
            val field = Mailchimp::class.java.getDeclaredField(AUDIENCE_SDK_SINGLETON_PARAM_NAME)
